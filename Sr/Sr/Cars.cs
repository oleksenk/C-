...
namespace sr_1
{
    class Cars
    {
        ...
        public Cars()
        {
            ...
            cars.Add(new Car(colors_1, 1993, 30000, 200));
            cars.Add(new Car(colors_2, 1994, 50000, 250));
            cars.Add(new Car(colors_1, 1995, 61000, 230));
            cars.Add(new Car(colors_2, 1998, 53000, 120));
            cars.Add(new Car(colors_3, 2000, 130000, 250));
        }
        ...
        public void findCar(byte amount, string color, int yearOfMade = 0, int price = 0, int enginePower = 0)
        {
            ...
            {
                Console.WriteLine("\nОшибка, автомобиля с такими характеристиками нету!):");
            }
        }
